error id: file:///C:/Users/Lenin/Desktop/Practicum-1.1/Practicum1.1/src/main/scala/data/LecturaCSV.scala:
file:///C:/Users/Lenin/Desktop/Practicum-1.1/Practicum1.1/src/main/scala/data/LecturaCSV.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -fs2/data/csv/lenient/attemptDecodeUsingHeaders.
	 -fs2/data/csv/lenient/attemptDecodeUsingHeaders#
	 -fs2/data/csv/lenient/attemptDecodeUsingHeaders().
	 -fs2/data/csv/generic/semiauto/attemptDecodeUsingHeaders.
	 -fs2/data/csv/generic/semiauto/attemptDecodeUsingHeaders#
	 -fs2/data/csv/generic/semiauto/attemptDecodeUsingHeaders().
	 -utilities/CSVDecoder.attemptDecodeUsingHeaders.
	 -utilities/CSVDecoder.attemptDecodeUsingHeaders#
	 -utilities/CSVDecoder.attemptDecodeUsingHeaders().
	 -attemptDecodeUsingHeaders.
	 -attemptDecodeUsingHeaders#
	 -attemptDecodeUsingHeaders().
	 -scala/Predef.attemptDecodeUsingHeaders.
	 -scala/Predef.attemptDecodeUsingHeaders#
	 -scala/Predef.attemptDecodeUsingHeaders().
offset: 691
...
object LecturaCSV {
  ...
  def readMoviesFromCsv(filePath: Path, separator: Char = ';'): IO[List[Either[String, Movie]]] = {
    ...
    Files[IO]
      ...
      .through(attemptDecod@@eUsingHeaders[Movie](separator = separator))
      .map {

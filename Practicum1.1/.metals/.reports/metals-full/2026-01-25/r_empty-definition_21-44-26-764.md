error id: file:///C:/Users/Lenin/Desktop/Practicum-1.1/Practicum1.1/src/main/scala/data/LecturaCSV.scala:Path.
...
non-local guesses:
	 ...
	 -fs2/io/file/Path#
	 -fs2/io/file/Path().
	 -fs2/data/csv/generic/semiauto/Path.
	 -fs2/data/csv/generic/semiauto/Path#
	 -fs2/data/csv/generic/semiauto/Path().
	 -utilities/CSVDecoder.Path.
	 -utilities/CSVDecoder.Path#
	 -utilities/CSVDecoder.Path().
	 -Path.
	 -Path#

error id: file:///C:/Users/Lenin/Desktop/Practicum-1.1/Practicum1.1/src/main/scala/data/LecturaJSON.scala:
file:///C:/Users/Lenin/Desktop/Practicum-1.1/Practicum1.1/src/main/scala/data/LecturaJSON.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -utilities/Parsear_JSON.parseJsonField.
	 -utilities/Parsear_JSON.parseJsonField#
	 -utilities/Parsear_JSON.parseJsonField().
	 -models/Parsear_JSON.parseJsonField.
	 -models/Parsear_JSON.parseJsonField#
	 -models/Parsear_JSON.parseJsonField().
	 -Parsear_JSON.parseJsonField.
	 -Parsear_JSON.parseJsonField#
	 -Parsear_JSON.parseJsonField().
	 -scala/Predef.Parsear_JSON.parseJsonField.
	 -scala/Predef.Parsear_JSON.parseJsonField#
	 -scala/Predef.Parsear_JSON.parseJsonField().
offset: 5608
  ...
  def contarTotalUserIds(filePath: Path, separator: Char = ';'): IO[Long] = {
    Files[IO].readAll(filePath)
      ...
      .map { row =>
        ...
        Parsear_JSON.pars@@eJsonField[Ratings](ratingsJson).length.toLong
      }
      .compile
      .fold(0L)(_ + _)
  }

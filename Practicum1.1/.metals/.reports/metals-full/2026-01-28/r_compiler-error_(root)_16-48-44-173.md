error id: 77385626DD0013816A987F291335C33F
  ...
  def run: IO[Unit] = {
    ConexionDB.xa.use { transactor =>
      for {
        ...
        movies = results.collect { case Righ@@t(m) => m }
...
scala.runtime.Scala3RunTime$.assertFailed(Scala3RunTime.scala:11)
	...
	scala.meta.internal.pc.ScalaPresentationCompiler.hover$$anonfun$1(ScalaPresentationCompiler.scala:379)
```
#### Short summary: 
